<div class="<?= PREFIX ?>-bg-white <?= PREFIX ?>-section-border-bottom">
            ...
            <?php foreach (TEAM_CONTENTS['members'] as $teamMember): ?>
                <div class="col-12 col-lg-3 mb-3 px-lg-2 px-1">
                    <div class="<?= PREFIX ?>-<?= TEAM_CONTENTS['id'] ?>-card d-flex d-lg-block py-5 px-4 px-lg-2 px-xxl-5">
                        <div class="<?= PREFIX ?>-<?= TEAM_CONTENTS['id'] ?>-img me-3 me-md-5 mx-lg-auto flex-shrink-0">
                            <img class="<?= PREFIX ?>-<?= TEAM_CONTENTS['id'] ?>-img-border" src="./assets/Ellipse.svg">
